<template>
	<div class="container p-5">
		<h2 style="text-align: center; font-weight: bold; color: blue; background-color: yellow; font-family: comic sans MS; padding-top:20px; padding-bottom: 20px;">
			List of the Employees</h2><hr>
		...
		<table class="table table-bordered table-hover">
			<thead>
				<th colspan="6" style=" background-color: #000;"><h2 style="text-align: center; color: #fff;">All Employees so far..</h2></th>
				<tr align="center">
					<th>ID</th>
					<th>Name</th>
					<th>Email</th>
			...
			<tbody>
				<template v-for="employee in employees" :key="employee.id">
					<tr align="center">
						...
						<td>
							<button type="button" class="btn btn-sm btn-info" data-toggle="modal" data-target="#myModal" @click="editEmployee(employee)"><i class="fa fa-edit"></i>&nbsp;Edit</button>
							<button type="button" class="btn btn-sm btn-danger ml-2" @click="deleteEmployee(employee.id)"><i class="fa fa-edit"></i>&nbsp;Delete</button>
						</td>
					</tr>
				</template>
			</tbody>
